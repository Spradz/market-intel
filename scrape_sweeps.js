 ...
 *   SLACK_SWEEP_CHANNEL    — (optional) override channel name for logging, default #sweepstakes-intel
 *
 * Output:
 *   - Writes ./data/brief.json (merged with crypto data if present)
 *   - Posts a formatted Slack notification to your nominated channel
 *
 * Schedule (cron example — runs 07:15 AWST / 23:15 UTC, staggered from crypto):
 *   15 23 * * * cd /path/to/project && node scrape_sweeps.js >> logs/sweeps.log 2>&1
 */
