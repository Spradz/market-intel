 ...
 *
 * Schedule (cron example — runs 07:00 AWST / 23:00 UTC):
 *   0 23 * * * cd /path/to/project && node scrape_crypto.js >> logs/crypto.log 2>&1
 */
...
const SLACK_CHANNEL    = process.env.SLACK_CRYPTO_CHANNEL || "#igaming-intel"; // override per channel
